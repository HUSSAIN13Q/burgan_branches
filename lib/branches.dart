...
class BurganBankBranches extends StatelessWidget {
 ...
 List<Branch> branches = [
  Branch(
    ...
    imageUrl: 'asset/image/HQ.jpeg', // Local image asset
  ...
  Branch(
    ...
    imageUrl: 'asset/image/AvenuesBranch.jpeg', // Local image asset
  ...
  Branch(
    ...
    imageUrl: 'asset/image/SalmiyaBranch.jpeg', // Local image asset
  ...
  Branch(
    ...
    openingHours: 'Sun-Thu: 8:30 AM - 3:00 PM',
    imageUrl: 'asset/image/JabriyaBranch.jpeg', // Local image asset
  ...
  Branch(
    ...
    openingHours: 'Sun-Thu: 8:30 AM - 3:00 PM',
    imageUrl: 'asset/image/Fahaheel Branch.jpeg', // Local image asset
  ...
  Branch(
    ...
    openingHours: 'Sun-Thu: 8:30 AM - 3:00 PM',
    imageUrl: 'asset/image/FarwaniyaBranch.jpg', // Local image asset
  ...
  Branch(
    ...
    openingHours: 'Sun-Thu: 8:30 AM - 3:00 PM',
    imageUrl: 'asset/image/HawalliBranch.JPG', // Local image asset
  ...
  Branch(
    ...
    openingHours: 'Sun-Thu: 8:30 AM - 3:00 PM',
    imageUrl: 'asset/image/AhmadiBranch.jpg', // Local image asset
  ...
  Branch(
    ...
    openingHours: 'Sun-Thu: 8:30 AM - 3:00 PM',
    imageUrl: 'asset/image/MishrefBranch.jpeg', // Local image asset
  ...
  Branch(
    ...
    openingHours: 'Sun-Thu: 8:30 AM - 3:00 PM',
    imageUrl: 'asset/image/AdailiyaBranch.jpeg', // Local image asset
...
class BranchDetailPage extends StatelessWidget {
 ...
 @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text(branch.name,style: const TextStyle(
                color: Color.fromARGB(255, 247, 247, 247), 
              ),),
        backgroundColor: const Color(0xFF0033A0), // Blue app bar
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            // Display branch image from assets
            ClipRRect(
            ...
            Text(
              ...
              style: const TextStyle(
                ...
                color: Color(0xFF0033A0), // Blue color
              ),
            ),

            const SizedBox(height: 16),

            // Display static map from a network URL (map image)
            Container(
      ...
      backgroundColor: const Color(0xFFF0F4F8), // Light blue background
    );
  }
}